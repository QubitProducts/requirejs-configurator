...
module.exports = function (root, cb, include_dev_dependencies) {
  var config = generateNpmConfig(root, include_dev_dependencies);
...
function generateNpmConfig(root, include_dev_dependencies) {
  var dependencies = readDependencies(root, include_dev_dependencies);
  var options = {
 ...
 */
function readDependencies(path, include_dev_dependencies) {
    return !include_dev_dependencies
